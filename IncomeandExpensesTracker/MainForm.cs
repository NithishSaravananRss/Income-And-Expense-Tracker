...
namespace IncomeandExpensesTracker
{
    public partial class MainForm : Form
    {
        ...
        public void displayUserName()
        {
            ...
            getusername.Text = "Welcome "+ getUsername.Substring(1,0).ToUpper() + getUsername.Substring(0);
        }

        private void close_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Are you sure you wan to close", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                == DialogResult.Yes)
            {
                Application.Exit();
            }
        ...
        {
            if(MessageBox.Show("Are you sure you wan to logout?","Confirmation Message",MessageBoxButtons.YesNo,MessageBoxIcon.Question)
                == DialogResult.Yes)
            {
